...
RSpec.describe Api::V1::PostsController, type: :controller do
  ...
  context "unauthenticated user" do
    it "PUT update returns http unathenticated" do
      put :update, topic_id: my_topic.id, id: my_post.id, post: {title: "Post Title", body: "Post Description Post Description"}
      expect(response).to have_http_status(401)
    end
    
    it "POST create returns http unauthenticated" do
      post :create, topic_id: my_topic.id, post: {title: "Post Title", body: "Post Description Post Description"}
      expect(response).to have_http_status(401)
    end
  ...
  context "authenticated and authorized users" do
    ...
    describe "PUT update" do
      before { put :update, topic_id: my_topic.id, id: my_post.id, post: {title: "Post Title", body: "Post Description Post Description"} }
    ...
    describe "POST create" do
      before { post :create, topic_id: my_topic.id, user_id: my_user.id, post: {title: my_post.title, body: my_post.body} }
